...
best_depth = 3
best_alpha = 0.003329317708903727 
# encontrados a partir das curvas acima
...
dt = DecisionTreeClassifier(max_depth=best_depth, ccp_alpha=best_alpha)
dt.fit(X_train, y_train)
...
```
`Train score: 0.9751552795031055`
